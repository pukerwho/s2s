...
<div class="services pt-20">
	<div class="container mx-auto">
		...
		<div class="services_nav flex justify-center mb-12">
			<?php 
			...
			?>
				<li class="list-none border-2 border-gray-400 mx-2"><a href="<?php the_permalink(); ?>" class="block text-center py-2 px-4"><?php the_title(); ?></a></li>
			<?php endwhile; endif; wp_reset_postdata(); ?>
		</div>
		<div class="w-3/4 mx-auto">
			<div class="services_list flex flex-wrap justify-center mx-0 lg:-mx-4">
				<?php 
					$services_query = new WP_Query(array(
						'post_type' => 'services',
						'posts_per_page' => -1,
